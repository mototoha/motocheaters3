...
# Главное меню  ---------------------------------------------------
hello = 'Привет, {}! А не хочешь ли ты узнать, кто кидала? Напиши номер телефона, банковской карты или адрес страницы.'
...
help_us = """Если помогла группа, помоги и ты нам, даже 50-100 руб. очень помогут общему делу!\n 
          Вот карта Сбербанка админа: 5469 3800 3591 7540
          """
...
thanks_answer = 'Пожалуйста!'

# Ответы на запросы кидал ----------------------------------------------------------------------------------------------
is_cheater = 'Это кидала! Не доверяй ему. \n'
many_records = 'У нас больше одной записи. \n'
cheater_info = 'Пользователь @{vk_id} засветился в нашей базе. \n'
vk_id_search = 'Ты проверяешь пользователя @id{} \n'
group_id_search = 'Ты проверяешь группу @club{} \n'
item_search = 'Ты проверяешь {}: {} \n'
proof_links = 'Вот пруфы: \n'
no_proof_links = """Доказательства и факты можешь найти, воспользовавшись поиском в группе про кидал: \n
                    @motokidala"""
is_fifty = 'Иногда кидает. А иногда нет. Будь осторожен. \n'
not_cheater = """В наших базах ничего не найдено. \n 
                 Советуем перед покупкой посоветоваться с ребятами 
                 из нашей группы против кидал: vk.com/motokidala \n"""
